...
def train_workflow(hidden_dim, dataset, save_dir="./checkpoints"):
    # Load text
    ...
    model_name = f"rnn_hidden_dim={hidden_dim}"
    ...
    model = RNNBaseline(
        vocab_size, n_embd=128, block_size=128, hidden_dim=hidden_dim, n_layers=2
    ).to(device)
